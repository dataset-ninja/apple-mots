...
def convert_and_upload_supervisely_project(
    ...
    def create_unique_im_name(im_path):
        image_subfolder_with_name = im_path.split("images/")[1]
        unique_im_name = image_subfolder_with_name.replace("/", "_")
        return unique_im_name
    ...
    def create_ann(image_path):
        ...
        ann_subfolder = image_path.split("images")[-1]
        mask_path = anns_path + ann_subfolder
    ...
    obj_class = sly.ObjClass("apple", sly.Bitmap)
    ...
    for ds_name in all_data:
        ...
        for img_pathes_batch in sly.batched(images_pathes, batch_size=batch_size):
            img_names_batch = [create_unique_im_name(im_path) for im_path in img_pathes_batch]
